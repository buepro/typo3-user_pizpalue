...
return [
    'BE' => [
        'debug' => false,
        'installToolPassword' => '$argon2i$v=19$m=65536,t=16,p=1$aGdvb2xSeWZWbkI5eHJEVQ$/lmODT0AqG5BvXhGqMrJMIWWQcNKcp75I+OPq3HI38o',
        'passwordHashing' => [
    ...
    'EXTENSIONS' => [
        'backend' => [
            'backendFavicon' => '',
            'backendLogo' => 'EXT:pizpalue/Resources/Public/Images/backend-logo.svg',
            'loginBackgroundImage' => 'EXT:pizpalue/Resources/Public/Images/backend-login-background.jpg',
            'loginFootnote' => '',
            'loginHighlightColor' => '',
            'loginLogo' => 'EXT:pizpalue/Resources/Public/Images/backend-login-logo.svg',
            'loginLogoAlt' => '',
        ],
        'bootstrap_package' => [

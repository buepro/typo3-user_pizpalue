...
/**
 * Show main menu dropdowns when hovering over the main menu entries.
 */
// pp.domReady(function () {
//     setTimeout(() => {
//         const hoverDropdownElements = document.querySelectorAll('#mainnavigation button.nav-link-toggle');
